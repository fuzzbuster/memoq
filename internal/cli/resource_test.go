...
func stubRunAPI(t *testing.T) *captured {
	...
	c := &captured{}
	orig := runAPI
	runAPI = func(method, path string, body any) error {
...
func TestResourcePaths(t *testing.T) {
	cases := []struct {
		...
		{"memo delete", []string{"memo", "delete", "abc"}, "DELETE", "/api/v1/memos/abc"},
		...
		{"memo unreact", []string{"memo", "unreact", "abc", "r1"}, "DELETE", "/api/v1/memos/abc/reactions/r1"},
		...
		{"memo share", []string{"memo", "share", "abc", "--body", "{}"}, "POST", "/api/v1/memos/abc/shares"},
		{"memo unshare", []string{"memo", "unshare", "abc", "s1"}, "DELETE", "/api/v1/memos/abc/shares/s1"},
		...
		{"attachment delete", []string{"attachment", "delete", "id1"}, "DELETE", "/api/v1/attachments/id1"},
		{"attachment batch-delete", []string{"attachment", "batch-delete", "--body", "{}"}, "POST", "/api/v1/attachments:batchDelete"},
		...
		{"user delete", []string{"user", "delete", "1"}, "DELETE", "/api/v1/users/1"},
		...
		{"user update-setting", []string{"user", "update-setting", "1", "GENERAL", "--body", "{}"}, "PATCH", "/api/v1/users/1/settings/GENERAL"},
		...
		{"user delete-token", []string{"user", "delete-token", "1", "tok9"}, "DELETE", "/api/v1/users/1/personalAccessTokens/tok9"},
		...
		{"shortcut delete", []string{"shortcut", "delete", "1", "s2"}, "DELETE", "/api/v1/users/1/shortcuts/s2"},
		...
		{"instance update-setting", []string{"instance", "update-setting", "GENERAL", "--body", "{}"}, "PATCH", "/api/v1/instance/settings/GENERAL"},
